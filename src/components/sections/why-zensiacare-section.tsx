...
export function WhyZensiaCareSection() {
  return (
    <section id="about" className="py-20 lg:py-28 bg-[#1E3A5F]">
          ...
          {FEATURES.map(({ icon: Icon, title, description }) => (
            <StaggerItem key={title}>
              <div className="group bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-300">
                <div className="w-12 h-12 bg-[#D4A843]/20 rounded-xl flex items-center justify-center mb-5 group-hover:bg-[#D4A843]/30 transition-colors">
                  <Icon className="text-[#D4A843]" size={24} />
                </div>
