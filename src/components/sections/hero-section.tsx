    ...
    >
      ...
      <div className="p-8">
        ...
        <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true) }} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-bold rounded-xl py-4 text-base flex items-center justify-center gap-2 transition-all duration-300 shadow-lg shadow-[#2563EB]/25 mt-2"
          >
            Get Free Quote
            <ArrowRight size={16} />
          </button>
