        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <div className="text-2xl font-display font-extrabold mb-3">
              Zensia<span className="text-[#D4A843]">Care</span>
            </div>
            ...
            <div className="flex gap-3">
              {SOCIAL_LINKS.map(({ label, svg }) => (
                <a
                  key={label}
                  href="#"
                  className="w-9 h-9 bg-white/10 hover:bg-[#D4A843]/20 rounded-full flex items-center justify-center transition-colors"
                  aria-label={label}
                >
                  {svg}
                </a>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {QUICK_LINKS.map((link) => (
                <li key={link}>
                  <a href="#" className="text-white/50 hover:text-[#D4A843] text-sm transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                className="w-full bg-white/10 border border-white/20 text-white placeholder:text-white/30 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-[#D4A843] transition-colors"
              />
              <button className="w-full bg-[#D4A843] hover:bg-[#B8922E] text-[#1E3A5F] font-semibold rounded-lg px-3 py-2 text-sm transition-colors">
                Subscribe
              </button>
            </div>
          </div>
